...
module butterfly #(
    ...
    // -------------------------------------------------------------------------
    parameter IWIDTH = 12,  // Input width per component (real/imag)
    parameter CWIDTH = 16,  // Twiddle factor precision
    parameter OWIDTH = 12,  // Output width per component
...
// ========================================================================
  ...
  convround #(CWIDTH+IWIDTH+3, OWIDTH, SHIFT+5)
